...
import Svg, { G, Rect, Mask, Path, Defs, ClipPath, SvgProps } from 'react-native-svg';

const EnIcon = (props: SvgProps) => (
  <Svg
    //@ts-ignore
    ...
    <G clipPath="url(#a)">
      ...
      <Mask id="b" width={28} height={20} x={0} y={0} maskUnits="userSpaceOnUse">
        <Rect width={28} height={20} fill="#fff" rx={2} />
      </Mask>
      <G mask="url(#b)">
        ...
        />
        <Path fill="#E6273E" fillRule="evenodd" d="M0 12h12v8h4v-8h12V8H16V0h-4v8H0v4Z" clipRule="evenodd" />
      </G>
    </G>
    <Defs>
      <ClipPath id="a">
