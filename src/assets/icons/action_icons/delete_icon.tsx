...
const DeleteIcon = (props: SvgProps & { xmlns?: string; xmlSpace?: 'preserve'; visible: boolean }) => (
  <Svg disabled={!props.visible} width={16} height={16} stroke="#000" viewBox="0 0 348.333 348.334" {...props}>
    {props.visible && (
